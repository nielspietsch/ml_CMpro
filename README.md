...
The approach consists of 5 scripts that allow for quantification of proliferating cardiomyocytes based on nuclear Ethynyl-deoxyuridine (EdU) and percentriolar marker 1 (PCM1) signals. The basis are confocal images of engineered 3D tissues. Stardist nuclear segmentation is run via the GPU to improve speed.
